...
<div class="page-header-banner bagels-overlay">
    ...
    <div class="container phb-container bagels-pos-relative">
        <div class="phb-content">
            <h1 class="phb-heading bagels-ff-gilroy-bold-alt">Do Contact Form</h1>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="vc-theme-title vc-tt-align-center vc-tt-dark">
                    ...
                    <h2 class="vc-tt-title">Do Contact Form</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="ptc-form">
                        <?php
                        echo do_shortcode( '[docontact_form]' ); // Add DoContact Form short code between ''
                        ?>
                    </div>
                </div>
            </div>
